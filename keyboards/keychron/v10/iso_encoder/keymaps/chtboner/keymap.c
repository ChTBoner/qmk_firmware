...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_iso_90(
        RGB_TOG,  _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,            NK_TOGG,
        _______,  RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,   RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,            _______,

        _______,  _______,  _______,  _______,  _______,  _______,  _______,                        KC_HOME,  KC_INS,   KC_DEL,  KC_END,  KC_PGUP,    _______,  _______,                      _______,
        _______,  KC_CAPS,  _______,  _______,  _______,  QK_MAKE,  _______,                        KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_PGDN,  _______,  _______,  _______,            KC_PSCR,
    ...
    [WIN_FN] = LAYOUT_iso_90(
        RGB_TOG,  _______,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FLXP,  RGB_VAD,   RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,   KC_VOLU,  _______,            NK_TOGG,
        _______,  RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,   RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,   _______,  _______,            _______,
